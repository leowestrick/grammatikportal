...
const grammatikUebungen = [
  ...
  { title: "ihn oder ihn, ihm oder im", description: "Wann benutzt man ihn,in,ihm oder im", link: "/uebungen/rechtschreibung/ihn-in-ihm-im" },
]
  ...
  return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 pb-20">
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8 mx-30">
          <h1 className="text-4xl font-bold mb-12 text-center text-gray-800">Rechtschreibübungen</h1>
